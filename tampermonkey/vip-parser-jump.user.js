...
(function () {
  ...
  const API_LINES = [
    ...
    { id: 10, name: '789解析',     url: 'https://jiexi.789jiexi.icu:4433/?url=' },
    { id: 11, name: '极速解析',     url: 'https://jx.2s0.cn/player/?url=' },
    { id: 12, name: '冰豆解析',     url: 'https://bd.jx.cn/?url=' },
    { id: 13, name: '973解析',     url: 'https://jx.973973.xyz/?url=' },
    { id: 14, name: 'CK',         url: 'https://www.ckplayer.vip/jiexi/?url=' },
    { id: 15, name: '夜幕',        url: 'https://www.yemu.xyz/?url=' },
    { id: 16, name: '盘古2',       url: 'https://www.pangujiexi.com/jiexi/?url=' },
    { id: 17, name: 'playm3u8',   url: 'https://www.playm3u8.cn/jiexi.php?url=' },
    { id: 18, name: '七七云',       url: 'https://jx.77flv.cc/?url=' },
    { id: 19, name: '芒果专用1',    url: 'https://video.isyour.love/player/getplayer?url=' },
    { id: 20, name: '芒果专用2',    url: 'https://im1907.top/?jx=' },
    { id: 21, name: 'HLS解析',     url: 'https://jx.hls.one/?url=' },
  ];
